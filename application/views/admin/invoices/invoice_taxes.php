			...
			<div class="card">
				...
				<div class="card-body">
					...
					<div class="form-group">
						...
						<br>
						<input type="checkbox" name="is_withholding" data-toggle="toggle" data-size="sm" value="1">
					</div>
					<div class="form-group">
						<label for="tax_rate"><?php echo $this->lang->line('ms_title_tax_buy_account'); ?></label>
						<select class="form-control" name="pembelian_account_id" data-plugin="select_account" data-placeholder="<?php echo $this->lang->line('ms_title_tax_buy_account'); ?>">
						</select>
					</div>
					<div class="form-group">
						<label for="tax_rate"><?php echo $this->lang->line('ms_title_tax_sell_account'); ?></label>
						<select class="form-control" name="penjualan_account_id" data-plugin="select_account" data-placeholder="<?php echo $this->lang->line('ms_title_tax_sell_account'); ?>">
						</select>
					</div>
					<div class="form-group">
					...
					<table class="datatables-demo table table-striped table-bordered" id="xin_table">
						<thead>
							<tr>
								...
								<th><?php echo $this->lang->line('ms_title_tax_withholding'); ?></th>
								<th><?php echo $this->lang->line('ms_title_is_active'); ?></th>
