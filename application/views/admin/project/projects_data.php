								...
								<table class="datatables-demo table table-striped table-bordered" id="xin_projects_dashboard_table">
									<thead>
										...
										<?php foreach (total_last_tasks() as $ls_tasks) : ?>
											...
											/// set task progress
											if ($ls_tasks->task_progress == '' || $ls_tasks->task_progress == 0) : $progress = 0;
											else : $progress = $ls_tasks->task_progress;
											endif;
											// task progress
							...
							<div class="box-datatable table-responsive">
								<table class="datatables-demo table table-striped table-bordered" id="xin_projects_dashboard_table">
									<thead>
										...
										foreach (total_last_invoices() as $ls_invoices) : ?>
											<?php
											// get country
							...
							<div class="box-datatable table-responsive">
								<table class="datatables-demo table table-striped table-bordered" id="xin_projects_dashboard_table">
									<thead>
										...
										<?php $role_resources_ids = $this->Xin_model->user_role_resource();
										foreach (total_last_estimates() as $ls_estimates) : ?>
											<?php
											/// get country
							...
							<div class="box-datatable table-responsive">
								<table class="datatables-demo table table-striped table-bordered" id="xin_projects_dashboard_table">
									<thead>
										...
										<?php $role_resources_ids = $this->Xin_model->user_role_resource();
										foreach (total_last_5_invoice_payments() as $ls_invoice_payments) : ?>
											<?php
											// transaction date
							...
							<div class="box-datatable table-responsive">
								<table class="datatables-demo table table-striped table-bordered" id="xin_projects_dashboard_table">
									<thead>
										...
										<?php $role_resources_ids = $this->Xin_model->user_role_resource();
										foreach (total_last_clients() as $ls_clients) : ?>
											<?php
											// get country
							...
							<div class="box-datatable table-responsive">
								<table class="datatables-demo table table-striped table-bordered" id="xin_projects_dashboard_table">
									<thead>
										...
										<?php $role_resources_ids = $this->Xin_model->user_role_resource();
										foreach (total_last_leads() as $ls_leads) : ?>
											<?php
											// get country
							...
							<div class="box-datatable table-responsive">
								<table class="datatables-demo table table-striped table-bordered" id="xin_projects_dashboard_table">
									<thead>
										...
										<?php $role_resources_ids = $this->Xin_model->user_role_resource();
										foreach (total_last_5_qprojects() as $ls_qprojects) : ?>
											<?php
