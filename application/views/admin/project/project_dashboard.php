											...
											foreach ($projects->result() as $eproject) { ?>
												...
												<tr>
													<td style="vertical-align: inherit;">
														<div style="width:4px;border:5px solid <?php echo $dc_color[$dj]; ?>;"></div>
													</td>
								...
								<div class="table-responsive">
									<table class="table mb-0 table-dashboard">
										<tbody>
											<tr>
												<td style="vertical-align: inherit;">
													<div style="width:4px;border:5px solid #647c8a;"></div>
												</td>
												<td><?php echo $this->lang->line('xin_project_clients'); ?> (<?php echo total_clients(); ?>)</td>
											</tr>
											<tr>
												<td style="vertical-align: inherit;">
													<div style="width:4px;border:5px solid #2196f3;"></div>
												</td>
									...
									<table class="table mb-0 table-dashboard">
										<tbody>
											...
											foreach ($tasks->result() as $etask) { ?>
												...
												<tr>
													<td style="vertical-align: inherit;">
														<div style="width:4px;border:5px solid <?php echo $dc_color[$sj]; ?>;"></div>
													</td>
