				...
				<div class="row">
					<div class="col-md-6">
						<div class="form-group">
							...
							<select name="vendor_id" id="vendor_id" class="form-control select2" data-plugin="select_account" data-placeholder="<?= $this->lang->line('ms_title_select_options'); ?>" required>
							</select>
						</div>
					</div>
					<div class="col-md-6">
