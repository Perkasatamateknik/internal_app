...
<div class="row">
	...
	<div class="col-md-auto mr-0 mb-2 pr-0">
		<a href="<?= base_url('admin/finance/accounts/trans_doc?type=expense') ?>" id="expense" class="btn btn-ajax-trans btn-<?= $type == "expense" ? "primary" : "white"; ?>"><?= $this->lang->line('ms_title_expense'); ?></a>
	</div>
</div>