...
<body>
	<div class="container-fluid">
		<div class="header">
			<img src="https://i.ibb.co/dMhvLmW/Headerpd.png" alt="Kop Surat" class="img-fluid" width="100%" draggable="false" />
		</div>
		<br />
		<div class="card mx-0">
			<div class="card-body">
							...
							<table class="table table-striped" id="ms_table_items">
								...
								<tbody>
									...
									<?php if (count($records) == 0) { ?>
										<tr>
											<td colspan="5" class="text-center"><?= $this->lang->line('ms_empty_item'); ?></td>
										</tr>
									<?php }; ?>
								</tbody>
								<tfoot>
									<tr>
										<td colspan="3" class="text-right"><?= $this->lang->line('ms_total_qty'); ?></td>
