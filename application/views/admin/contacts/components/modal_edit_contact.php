...
<div class="modal fade" id="modal-result" role="dialog" aria-labelledby="modelTitleId" aria-hidden="true" data-ke>
	<div class="modal-dialog modal-lg" role="document">
		<div class="modal-content ">
			...
			<?php $hidden = array('contacts' => 'UPDATE', '_token' => $record->contact_id); ?>
			<?php echo form_open('admin/contacts/update', $attributes, $hidden); ?>
			<div class="form-body">
					...
					<div class="row m-b-1">
						<div class="col-md-6">
							<div class="form-group">
								...
								<select class="form-control" name="contact_type" data-plugin="select_type" data-placeholder="<?php echo $this->lang->line('ms_title_contact_type'); ?>" required>
									<option value="<?= $record->type_id; ?>"><?= $record->contact_type; ?></option>
						...
						<div class="col-md-6">
							<div class="form-group">
								...
								<input type="text" class="form-control" name="contact_name" placeholder="<?php echo $this->lang->line('ms_title_contact_name'); ?>" value="<?= $record->contact_name; ?>" required>
							</div>
						</div>
						<div class="col-md-6">
							<div class="form-group">
								<label class="form-label"><?php echo $this->lang->line('ms_title_company'); ?></label>
								<input type="text" class="form-control" name="company_name" placeholder="<?php echo $this->lang->line('ms_title_company'); ?>" value="<?= $record->company_name; ?>" required>
							</div>
						</div>
						<div class="col-md-6">
							<div class="form-group">
								<label class="form-label"><?php echo $this->lang->line('ms_title_billing_address'); ?></label>
								<input type="text" class="form-control" name="billing_address" placeholder="<?php echo $this->lang->line('ms_title_billing_address'); ?>" value="<?= $record->billing_address; ?>" required>
							</div>
						</div>
						<div class="col-md-6">
							<div class="form-group">
							...
							<div class="form-group">
								<div class="row">
									<div class="col-md-6">
										...
										<input class="form-control" placeholder="<?php echo $this->lang->line('xin_city'); ?>" name="city" type="text" value="<?= $record->city; ?>">
									</div>
									<div class="col-md-6">
										<label class="form-label"><?php echo $this->lang->line('xin_state'); ?></label>
										<input class="form-control" placeholder="<?php echo $this->lang->line('xin_state'); ?>" name="province" type="text" value="<?= $record->province; ?>">
									</div>
								</div>
							</div>
						</div>
						<div class="col-md-6">
							<div class="form-group">
								...
								<input type="text" class="form-control" name="email_address" placeholder="<?php echo $this->lang->line('ms_title_email_address'); ?>" value="<?= $record->email_address; ?>">
							</div>
						</div>
						<div class="col-md-6">
							<div class="form-group">
								<label class="form-label"><?php echo $this->lang->line('xin_phone'); ?></label>
								<input type="text" class="form-control" name="phone_number" placeholder="<?php echo $this->lang->line('xin_phone'); ?>" value="<?= $record->phone_number; ?>">
							</div>
						</div>
						<div class="col-md-6">
							<div class="form-group">
								<label class="form-label"><?php echo $this->lang->line('ms_title_tax_number'); ?></label>
								<input type="text" class="form-control" name="tax_number" placeholder="<?php echo $this->lang->line('ms_title_tax_number'); ?>" value="<?= $record->tax_number; ?>">
							</div>
						</div>
						<div class="col-md-6">
							<div class="form-group">
								<label class="form-label"><?php echo $this->lang->line('ms_title_date_of_birth'); ?></label>
								<input type="date" class="form-control" name="date_of_birth" placeholder="<?php echo $this->lang->line('ms_title_date_of_birth'); ?>" value="<?= $record->date_of_birth; ?>">
							</div>
						</div>
					</div>
				</div>
