...
<div class="modal fade" id="modal-result-edit" role="dialog" aria-labelledby="modelTitleId" aria-hidden="true" data-ke>
	<div class="modal-dialog modal-lg" role="document">
		<div class="modal-content">
			...
			<?php $hidden = array('contacts' => 'UPDATE', '_token' => $record->id); ?>
