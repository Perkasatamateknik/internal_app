					...
					<div class="col-md-auto">
						<div class="row">
							<div class="col-md-auto px-0">
								<a href="<?= base_url('/admin/finance/liabilities/print?id=' . $record->trans_number) ?>" target="_blank" class=" btn btn-primary btn-sm"><i class="fa fa-print fa-fw" aria-hidden="true"></i><?= $this->lang->line('xin_print'); ?> </a>
							</div>
							<div class="col-md-auto">
