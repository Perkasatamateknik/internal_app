	...
	jQuery("#treeview_r1").kendoTreeView({
		...
		dataSource: [
...

			{
				id: "",
				class: "role-checkbox custom-control-input",
				text: "<?php echo $this->lang->line('ms_title_finance'); ?>",
				add_info: "",
				value: "1000",
				items: [{
						id: "",
						class: "role-checkbox custom-control-input",
						text: "<?php echo $this->lang->line('ms_title_transfer'); ?>",
						add_info: "<?php echo $this->lang->line('xin_add_edit_view_delete_role_info'); ?>",
						value: "1001",
						items: [{
								id: "",
					...
					},
					{
						id: "",
						class: "role-checkbox custom-control-input",
						text: "<?php echo $this->lang->line('ms_title_spend'); ?>",
						add_info: "<?php echo $this->lang->line('xin_add_edit_view_delete_role_info'); ?>",
						value: "1006",
						items: [{
								id: "",
					...
					},
					{
						id: "",
						class: "role-checkbox custom-control-input",
						text: "<?php echo $this->lang->line('ms_title_receive'); ?>",
						add_info: "<?php echo $this->lang->line('xin_add_edit_view_delete_role_info'); ?>",
						value: "1011",
						items: [{
								id: "",
					...
					},
					{
						id: "",
						class: "role-checkbox custom-control-input",
						text: "<?php echo $this->lang->line('ms_title_expense'); ?>",
						add_info: "<?php echo $this->lang->line('xin_add_edit_view_delete_role_info'); ?>",
						value: "1017",
						items: [{
								id: "",
					...
					},
					{
						id: "",
						class: "role-checkbox custom-control-input",
						text: "<?php echo $this->lang->line('ms_title_invoice'); ?>",
						add_info: "<?php echo $this->lang->line('xin_add_edit_view_delete_role_info'); ?>",
						value: "1023",
						items: [{
								id: "",
					...
					},
					{
						id: "",
						class: "role-checkbox custom-control-input",
						text: "<?php echo $this->lang->line('ms_title_income'); ?>",
						add_info: "<?php echo $this->lang->line('xin_add_edit_view_delete_role_info'); ?>",
						value: "1028",
						items: [{
								id: "",
