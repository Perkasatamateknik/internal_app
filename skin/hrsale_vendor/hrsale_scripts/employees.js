$(document).ready(function () {
	...
	$("#ihr_report").submit(function (e) {
		...
		var xin_table2 = $("#xin_table").dataTable({
			...
			ajax: {
				url:
					site_url +
					"employees/employees_list/?ihr=true&company_id=" +
					$("#filter_company").val() +
					"&location_id=" +
					$("#filter_location").val() +
					"&department_id=" +
	...
	jQuery("#aj_company_emp").change(function () {
		...
		jQuery.get(
			base_url + "/get_company_office_shifts/" + jQuery(this).val(),
			function (data, status) {
	...
	jQuery("#filter_company").change(function () {
		...
		jQuery.get(
			site_url + "employees/filter_company_flocations/" + jQuery(this).val(),
			function (data, status) {
